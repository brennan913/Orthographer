...
public class Orthographer {
    ...
    /**
     * scan in document and store in ArrayList close input stream
     * 
     ...
     * @param               String[] fromArray - array of morphemes to check for a
    ...
    /**
     * Replace method to convert each unmodified morpheme between practical
     * orthography and IPA
     * 
     * @param ArrayList<String> a - arraylist lines of text to be replaced
     * @param String[] toArray - array of morphemes the new document will be written
     *        in
     * @param String[] fromArray - array of morphemes the original text was written
     *        in
     */
    ...
    /**
     * Print print the stored text in its current form line by line increments
     * printCount
     * 
    ...
    public static final void main(String[] args) {
        /*
         * prompt(); scan(); print(); //fromIPA(); print(); toIPA(); print(); fromIPA();
         * print(); //write();
         */
    }
