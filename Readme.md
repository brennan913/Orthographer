...
Orthographer takes a text file of any size and converts its contents from phonemic transcription in IPA to the relevant practical system of writing, which usually make use of characters from the Roman Alphabet. 
#### Sample Text
