...
Orthographer takes a text file of any size and converts its contents from phonemic transcription in IPA to practical Seke written using exclusively characters from the Roman Alphabet. 
#### Sample Text
